...
export const ABOUT_ME: TranslatableInfo[] = [
    {
        header: "Full‑stack developer z dużym doświadczeniem w technologiach .NET, Angular i React, aktywnie korzystający z agentic coding.",
    ...
    {
        header: "Full-stack developer with extensive experience in .NET, Angular, and React, actively using agentic coding.",
